...
http://note.youdao.com/groupshare/?token=AE9F46916C444460B4B4F7F591727871&gid=80144203)
...
# 
docker exec -it mysql bash 进入mysql的容器

mysql -uroot -p123456 登录mysql root为账号名 123456为当时设置的密码

————————————————
版权声明：本文为CSDN博主「hualaoshuan」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/hualaoshuan/article/details/90815049

在安装完mysql后，利用navicat可能无法连接，报10060错误。
